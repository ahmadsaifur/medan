...
class Barang extends MY_Controller
{
	...
	public function tambah_klinik_baru2()
	{
		$dt['kategori'] = $this->m_kategori_barang->get_all();
		$dt['satuan'] = $this->m_kategori_barang->get_all_satuan();
		$this->load->view('barang/tambah_klinik_baru');
	}
				...
				if ($this->input->is_ajax_request()) {
					...
					if ($_POST) {
						...
						if ($this->form_validation->run() == TRUE) {
							...
							$update = $this->m_barang->update_barang($id_barang, $kode_barang, $nama, $id_kategori_barang, $stok, $harga, $keterangan);
							if ($update) {
								echo json_encode(array(
									'status' => 1,
