                ...
                <div class="news-detail-thumb">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="section-title wow fadeInUp animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                            <h2 class="text-capitalize">Crown dan Bridge (Gigi Tiruan Permanen) </h2>
                            <p class="text-justify">Crown gigi adalah sebuah metode yang dilakukan dengan memasangkan selubung gigi palsu pada bagian atas gigi yang rusak dengan pemasangan secara permanen. Metode ini dilakukan untuk mengembalikan bentuk, kekuatan, serta fungsi dari gigi</p>
                            <p class="text-justify">Crown gigi dibuat dengan bahan porselen, keramik, logam hingga resin. Tentunya, pilihan tersebut bisa disesuaikan dengan kebutuhan dan harga yang kami siapkan untuk perawatan</p>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                        <!-- SECTION TITLE -->
