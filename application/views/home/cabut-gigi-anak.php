                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="section-title wow fadeInUp animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                                <h2 class="text-capitalize">Cabut Gigi Anak</h2>
                                <p class="text-justify">Dapat Dilakukan pada gigi susu ataupun permanen, ya moms. Dokter Gigi di Poli Gigi Alkindi yang menangani kasus atau perawatan gigi anak, biasanya akan membuat suasana ruang tindakan menjadi menyenangkan untuk meminimalkan rasa takut anak. So, jangan takut cabut gigi anak anda di Poli Gigi Alkindi, Ya !</p>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <!-- SECTION TITLE -->
                            ...
                            <div class="media">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p class="media-heading"><a href="<?= base_url('') . $p->url . '/' . $p->slug ?>" class=""><i class="fa fa-check"></i> <?= $p->title ?></a></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
