...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> Obat Online</h5>
			<hr />
            
            <a href="<?php echo site_url('barang/tambah');?>" class="btn btn-success" id='TambahBarang'>Tambah Barang</a><!--
			<a href="<?php echo site_url('barang/update_stok_online'); ?>" class="btn btn-primary" id='UpdateStokBarang'>Update Stok Herbal</a>
			<a href="<?php echo site_url('barang/update_stok_online_kimia'); ?>" class="btn btn-primary" id='UpdateStokBarang_kimia'>Update Stok Kimia</a>-->
