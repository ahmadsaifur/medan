			...
			<div class='row'>
				...
				<div class='col-sm-9'>
					...
					<div class='alert alert-info TotalBayar'>
						...
						<h2 style="color: black">Total : <span id='TotalBayar'>Rp. <?php echo $master->total_awal; ?></span></h2>
						...
						<input type="hidden" id='TotalBayarHidden2' value="<?php echo $master->total_awal; ?>">
						...
						<div class='col-sm-5'>
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type='text' id='TotalBayarHidden3' class='form-control' value="<?php echo $master->grand_total; ?>" disabled>
									</div>
								</div>
								<div class="form-group">
