...
<style>
	...
	.form-control {
		border-radius: 0px;
		id_penjualan_d box-shadow: none;
	}
...
// cekvar($master);
$discountnya = $master->discount_total2;
$total_akhir = $master->bayar;
$discount_total_edit = $master->discount_total2;
						...
						<tbody>
							...
							foreach ($detail->result() as $d) {
								...
								<tr>
									<td>" . $no . "</td>
									<td>
										<input type='hidden' name='iddd[]' id='idd' value='" . ($d->kode_barang) . "'>
						...
						<div class='col-sm-5'>
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type='text' id='discount_all' class='form-control' value="<?php echo $discount_total_edit; ?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-6 control-label">Total Setelah Discount</label>
									<div class="col-sm-6">
										<input type='text' id='TotalBayarHidden3' class='form-control' disabled value="<?php echo $master->bayar; ?>">
									</div>
								</div>
								<div class="form-group">
