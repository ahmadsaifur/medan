<!--
 * ------------------------------------------------------------------------
 * @Author & editor		: Deny Priyana <denypriyana.offcial@gmail.com>
 * @Date       			: 01.2023
 * @copyright  			: PT. Alkindi
 * ------------------------------------------------------------------------
 -->
<!DOCTYPE html>
...
<head>
	...
	<meta name="description" content="Selamat Datang Di Website PT Al Kindi Indonesia - Real Health Comes From Nature" />
	<title>Transaksi klinik Alkindi Medan</title>
	<link rel="shortcut icon" href="images/LOGO_CS.png" type="image/x-icon">
	<link href="https://fonts.googleapis.com/css?family=Vast+Shadow" rel="stylesheet">

	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
	<script src="http://alkindiherbal.com/js/bootstrap.min.js"></script>
	<script src="http://alkindiherbal.com/js/aos.js"></script>
...
<body>
							...
							<div class='col-sm-5'>
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type='text' id='discc' class='form-control' name="discount">
										</div>
	...
	<script>
		...
		function BarisBaru() {
			...
			// 	Baris += "<span></span>";
			// Baris += "</td>";
			Baris += "<td><input type='text' step='any' class='form-control' id='discount' name='discount[]'onkeypress='return isNumber(event)' ></td>";
			Baris += "<td>";
			// Baris += "<input type='hidden' step='any' name='discountnya[]' id='discountnya'>";
			Baris += "<input type='text' step='any' class='form-control' id='discountnya' name='discountnya[]' onkeypress='return isNumber(event)' readonly>";
			Baris += "<span></span>";
			Baris += "</td>";
			Baris += "<td>";
